...
use crate::{cell, ByteOrderRead, CellType, LevelMask, UInt256, DEPTH_SIZE, SHA256_SIZE};
...
impl CellData {
    ...
    pub(crate) fn set_hash_depth(&mut self, index: usize, hash: &[u8], depth: u16) -> crate::Result<()> {
