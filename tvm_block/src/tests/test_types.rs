...
use crate::ed25519_sign_with_secret;
...
fn test_uint256_formatting() {
    ...
    assert_eq!(
        value.to_string(),
        "UInt256[[12, 34, 56, 78, 90, AB, CD, EF, 12, 34, 56, 78, 90, AB, CD, EF, 12, 34, 56, 78, 90, AB, CD, EF, 12, 34, 56, 78, 90, AB, CD, EF]]"
    );
    assert_eq!(
        format!("{:?}", value),
...
fn test_check_cell_types() {
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::LibraryReference, 2),
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::LibraryReference, 35),
        CellType::LibraryReference,
        0,
        None,
        None,
    ...
    DataCell::with_params(
        vec![Cell::default()],
        &prepare_data(CellType::LibraryReference, 34),
        CellType::LibraryReference,
        0,
        None,
        None,
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::MerkleProof, 2),
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::MerkleProof, 37),
        CellType::MerkleProof,
        0,
        None,
        None,
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::MerkleProof, 36),
        CellType::MerkleProof,
        0,
        None,
        None,
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::MerkleUpdate, 2),
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::MerkleUpdate, 71),
        CellType::MerkleUpdate,
        0,
        None,
        None,
    ...
    DataCell::with_params(
        vec![],
        &prepare_data(CellType::MerkleUpdate, 70),
        CellType::MerkleUpdate,
        0,
        None,
        None,
