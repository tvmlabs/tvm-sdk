...
1. Encode a message you will locally execute with [encode\_message](../../acki-nacki-sdk/types-and-methods/mod_abi.md#encode_message)
2. Download account boc the same way you did in [Run ABI Get method](run_abi_get_method.md)
3. Run the message on the downloaded state with [run\_executor](../../acki-nacki-sdk/types-and-methods/mod_tvm.md#run_executor) function
...
Use [calc\_storage\_fee](../../acki-nacki-sdk/types-and-methods/mod_utils.md#calc_storage_fee) method.
