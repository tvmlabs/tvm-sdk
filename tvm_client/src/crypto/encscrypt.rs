...
pub struct ParamsOfScrypt {
    ...
    /// attacks. Must be encoded with `base64`.
    pub salt: String,
    /// CPU/memory cost parameter
    pub log_n: u8,
    /// The block size parameter, which fine-tunes sequential memory read size
    /// and performance.
    pub r: u32,
...
pub fn scrypt(
    ...
    let scrypt_params =
        scrypt::Params::new(params.log_n, params.r, params.p, scrypt::Params::RECOMMENDED_LEN)
