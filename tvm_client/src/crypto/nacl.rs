...
pub fn nacl_sign(
    ...
    Ok(ResultOfNaclSign {
        signed: tvm_block::base64_encode(&signed),
    })
}
...
pub fn nacl_sign_open(
    ...
    Ok(ResultOfNaclSignOpen {
        unsigned: tvm_block::base64_encode(&unsigned),
    })
}
...
pub fn nacl_box(
    ...
    Ok(ResultOfNaclBox {
        encrypted: tvm_block::base64_encode(&padded_output),
    })
}
...
pub fn nacl_box_open(
    ...
    Ok(ResultOfNaclBoxOpen {
        decrypted: tvm_block::base64_encode(&padded_output),
    })
}
