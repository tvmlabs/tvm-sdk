...
#[cfg(feature = "gosh")]
use crate::executor::zk_halo2_with_vk_stub::ZKHALO2_VERIFY_WITH_VK_GAS_PRICE;
...
impl Gas {
    ...
    pub const fn basic_gas_price(
        ...
        // old formula from spec: (10 + instruction_length + 5 *
        // instruction_references_count) as i64
    ...
    /// Compute `ZKHALO2VERIFYWITHVK` usage cost (placeholder — see
    /// `tvm_vm/src/executor/zk_halo2_with_vk_stub.rs` for the design context).
    #[cfg(feature = "gosh")]
