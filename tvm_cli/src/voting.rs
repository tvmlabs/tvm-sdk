...
pub async fn create_proposal(
    ...
    if offline {
        ...
        call::call_contract(config, addr, MSIG_ABI, "submitTransaction", &params, keys, false, None).await
    }
}
...
pub async fn vote(
    ...
    if offline {
        ...
        call::call_contract(config, addr, MSIG_ABI, "confirmTransaction", &params, keys, false, None)
            .await
    }
}
