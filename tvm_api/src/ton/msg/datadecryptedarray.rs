...
pub struct DataDecryptedArray {
    pub elements: crate::ton::vector<crate::ton::msg::datadecrypted::DataDecrypted>,
}
...
impl crate::BareSerialize for DataDecryptedArray {
    ...
    fn serialize_bare(&self, _ser: &mut crate::Serializer) -> crate::Result<()> {
        let DataDecryptedArray { elements } = self;
        (elements as &dyn crate::ton::VectoredBare<crate::ton::msg::datadecrypted::DataDecrypted>)
            .serialize(_ser)?;
        Ok(())
    }
}
impl crate::BareDeserialize for DataDecryptedArray {
    fn deserialize_bare(_de: &mut crate::Deserializer) -> crate::Result<Self> {
        {
            let elements =
                <Vec<crate::ton::msg::datadecrypted::DataDecrypted> as crate::ton::VectoredBare<
