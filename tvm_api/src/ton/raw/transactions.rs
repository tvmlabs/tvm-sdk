...
pub struct Transactions {
    pub transactions: crate::ton::vector<crate::ton::raw::transaction::Transaction>,
...
impl crate::BareSerialize for Transactions {
    ...
    fn serialize_bare(&self, _ser: &mut crate::Serializer) -> crate::Result<()> {
        ...
        (transactions as &dyn crate::ton::VectoredBare<crate::ton::raw::transaction::Transaction>)
            .serialize(_ser)?;
...
impl crate::BareDeserialize for Transactions {
    fn deserialize_bare(_de: &mut crate::Deserializer) -> crate::Result<Self> {
        {
            let transactions =
                <Vec<crate::ton::raw::transaction::Transaction> as crate::ton::VectoredBare<
                    crate::ton::raw::transaction::Transaction,
                >>::deserialize(_de)?;
            let previous_transaction_id =
                _de.read_bare::<crate::ton::internal::transactionid::TransactionId>()?;
            Ok(Self { transactions, previous_transaction_id })
        }
    }
}
