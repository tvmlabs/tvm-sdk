...
pub struct Global {
    ...
    pub nodes: crate::ton::vector<crate::ton::PublicKey>,
}
impl Eq for Global {}
impl crate::BareSerialize for Global {
    ...
    fn serialize_bare(&self, _ser: &mut crate::Serializer) -> crate::Result<()> {
        let Global { tag, nodes } = self;
        _ser.write_bare::<crate::ton::int256>(tag)?;
        (nodes as &dyn crate::ton::VectoredBoxed<crate::ton::PublicKey>).serialize(_ser)?;
        Ok(())
    }
}
    ...
    fn deserialize_bare(_de: &mut crate::Deserializer) -> crate::Result<Self> {
        {
            ...
            let nodes = <Vec<crate::ton::PublicKey> as crate::ton::VectoredBoxed<
                crate::ton::PublicKey,
            >>::deserialize(_de)?;
            Ok(Self { tag, nodes })
        }
