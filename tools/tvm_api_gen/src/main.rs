...
const USAGE: &str = r#"
Usage:  tvm_api_gen [OPTIONS] <command> [args...]

Commands:
    api      Exports tvm client api JSON
    request  Executes tvm client api function
...
Example:
    tvm_api_gen request client.version
    tvm_api_gen request crypto.generate_random_bytes { length: 32 }
    tvm_api_gen request abi.attach_signature_to_message_body { \
