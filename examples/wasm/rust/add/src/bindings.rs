            ...
            pub mod add {
                ...
                macro_rules! __export_docs_adder_add_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        #[unsafe (export_name = "cabi_post_docs:adder/add@0.1.0#add")]
                        unsafe extern "C" fn _post_return_add(arg0 : * mut u8,) { unsafe
...
B\x03\x01p}\x01@\x01\x06kwargs\0\0\0\x04\0\x03add\x01\x01\x04\0\x14docs:adder/ad\
d@0.1.0\x05\0\x04\0\x16docs:adder/adder@0.1.0\x04\0\x0b\x0b\x01\0\x05adder\x03\0\
